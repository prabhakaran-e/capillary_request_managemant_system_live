...
const TableContent = ({currentUsers,navigate,getStatusBackgroundColor,handleCopyReqId,renderActionColumn,handleOpenInNewTab,formatCurrency,searchTerm ,dateFilters,viewMode,startIndex  }) => {
  return (
