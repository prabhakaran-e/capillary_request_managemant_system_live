...
const TableContents = ({filteredUsers,currentUsers,navigate,currentPage,itemsPerPage,handleCopyReqId,handleOpenInNewTab,formatCurrency,Pagination,totalPages,renderActionColumn,handlePageChange}) => {
    return (
